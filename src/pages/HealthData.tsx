  ...
  return (
    <div className="p-6 max-w-3xl mx-auto">
      <div className="mb-6">
        ...
        <p className="text-gray-400 text-sm mt-1">Search from our Filipino food database and log your meals.</p>
      </div>
      ...
      <div className="flex items-center gap-2 mb-4">
        <button onClick={() => setBudgetOnly(!budgetOnly)}
        ...
        {budgetOnly && (
          <span className="text-xs text-amber-600 font-medium bg-amber-50 px-3 py-1.5 rounded-xl border border-amber-200">
            💰 {budgetFoods.length} affordable meals
          </span>
        )}
      </div>
      ...
      {budgetOnly && (
        <div className="bg-amber-50 border border-amber-200 rounded-2xl px-4 py-3 mb-4">
          ...
          <p className="text-xs text-amber-700">Mga pagkaing abot-kaya para sa lahat — sardinas, tuyo, tokwa, kamote, at iba pa. Masustansya at hindi mahal!</p>
        </div>
      )}
